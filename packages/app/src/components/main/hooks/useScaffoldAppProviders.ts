...
export const useScaffoldProviders = (): IScaffoldAppProviders => {
  ...
  useEffect(() => {
    /**
     * This is for to auto connect to the burner wallet in dev environment when there is no cached provider
     * you can turn it off by settting {@link const_VITE_CONNECT_TO_BURNER_AUTOMATICALLY} to false
     * @param connector
     * @returns
     */
