...
import { DebugContracts, Greeter, Hints } from '~~/components/pages';
...
export const Main: FC = () => {
  ...
  // init contracts
  const yourContract = useAppContracts('Greeter', ethersContext.chainId);
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            <DebugContracts scaffoldAppProviders={scaffoldAppProviders} />
          </Route>
